...
**ZipFinam** — форк ZipLime под российский рынок. Тянет исторические котировки и каталог активов напрямую из API Финама.

Внутри живёт **ИИ-ассистент**: пишешь стратегию словами — он генерирует код и сразу запускает бэктест.
